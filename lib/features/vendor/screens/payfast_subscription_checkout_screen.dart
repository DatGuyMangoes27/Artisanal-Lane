...
class PayfastSubscriptionCheckoutScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PayfastSubscriptionCheckoutScreen> createState() =>
      _PayfastSubscriptionCheckoutScreenState();
}

class _PayfastSubscriptionCheckoutScreenState
    extends ConsumerState<PayfastSubscriptionCheckoutScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _loadError == null
          ...
          : _SubscriptionCheckoutErrorState(
              message: _loadError!,
              onRetry: _reload,
            ),
    );
...
class _SubscriptionCheckoutErrorState extends StatelessWidget {
  final String message;
  final Future<void> Function() onRetry;

  const _SubscriptionCheckoutErrorState({
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'PayFast could not load right now.',
